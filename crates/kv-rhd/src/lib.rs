...
pub use protocol::{
    ...
    RHYTHM_BOARD_ID, RhythmDataConfig, SAMPLES_PER_USB_BLOCK, USB3_BLOCK_SIZE_BYTES,
    RhythmConfigError, bytes_per_block, raw_word_to_signed_count, signed_count_to_microvolts,
    words_per_frame,
};
