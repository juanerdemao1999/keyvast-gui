...
mod tests {
    ...
    fn test_dc_impedance() {
        ...
        let mag = compute_impedance(&data, 30_000.0, 1000.0, ZcheckScale::Cs1pF).magnitude_ohms;
        assert!(
    ...
    fn test_sine_impedance() {
        ...
        let mag = compute_impedance(&data, sample_rate, freq, ZcheckScale::Cs1pF).magnitude_ohms;
        assert!(
    ...
    fn railed_channel_is_rejected_open_channel_is_not() {
        ...
        let railed: Vec<i16> = (0..n)
            ...
            .collect();
        let amp = compute_impedance(&railed, sample_rate, freq, ZcheckScale::Cs1pF).amplitude_uv;
