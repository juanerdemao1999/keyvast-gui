...
pub use protocol::{
    ...
    DEFAULT_RHD_DEVICE_ID, DEFAULT_RHD_SAMPLE_RATE, FrameLayout,
    RHD_AMPLIFIER_MICROVOLTS_PER_COUNT, RHD_BITFILE_CANDIDATES, RHYTHM_BOARD_ID, RhdChipType,
    RhythmConfigError, RhythmDataConfig, SAMPLES_PER_USB_BLOCK, USB3_BLOCK_SIZE_BYTES,
    bytes_per_block, raw_word_to_signed_count, signed_count_to_microvolts, words_per_frame,
};
