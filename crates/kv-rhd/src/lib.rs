...
pub use protocol::{
    CHANNELS_PER_STREAM, DEFAULT_RHD_SAMPLE_RATE, FrameLayout, RHD_AMPLIFIER_MICROVOLTS_PER_COUNT,
    RHYTHM_BOARD_ID, RhythmConfigError, RhythmDataConfig, SAMPLES_PER_USB_BLOCK,
